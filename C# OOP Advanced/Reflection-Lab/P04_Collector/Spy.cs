...
public class Spy
{
    ...
    public string RevealPrivateMethods(string className)
    {
        ...
        sb.AppendLine($"Base Class: {targetClass.BaseType.Name}");

        MethodInfo[] privateMethods = targetClass.GetMethods(BindingFlags.Instance |
    ...
    public string CollectGettersAndSetters(string className)
    {
        ...
        MethodInfo[] gettersAndSetters = targetClass.GetMethods(BindingFlags.Instance
             | BindingFlags.NonPublic | BindingFlags.Public)
            .Where(m => m.Name.StartsWith("get") || m.Name.StartsWith("set"))
            
            .ToArray();

        foreach (MethodInfo method in gettersAndSetters)
        {
